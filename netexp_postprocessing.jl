...
#UPATE 2/20: removed t (target compounds)
#t::Array{Int,1}, - t parameter in function definition
function formatted_netexp_results(x::Array{Int,1},compounds::Array{String,1},reactions::Array{String,1},X::Array{Any,1},Y::Array{Any,1})
...
function format_many(DATADIR::String,OUTDIR::String)
    ...
    for FNAME in readdir(DATADIR)
        ...
        newdata = formatted_netexp_results(x,compounds,reactions,X,Y)
...
### FORMAT SINGLE FILE
#########################
fullinpath = "results/simple/chiral0.json"
